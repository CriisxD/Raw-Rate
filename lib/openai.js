...
5. FORMATO ESTRICTO: Devuelve la respuesta en formato JSON puro. NO uses bloques de código markdown (\`\`\`json). Comienza directamente con la llave { y termina con la llave }.
