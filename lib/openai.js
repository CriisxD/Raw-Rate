  ...
  const response = await client.chat.completions.create({
    ...
    messages: [
      { role: 'system', content: SYSTEM_PROMPT },
      {
        role: 'user',
        content: [
          { type: 'text', text: `Datos Biométricos del Sujeto:\n- Edad: ${biometrics.age} años\n- Sexo Biológico: ${biometrics.gender}\n- Estatura: ${biometrics.height} cm\n\nTeniendo en cuenta esta información demográfica exacta para ajustar los estándares, los percentiles sociales y el ratio de asimetría/estatura espacial, analiza estas 4 imágenes y devuelve el JSON de evaluación clínica estricta.` },
          ...imageContent,
        ],
      },
    ],
